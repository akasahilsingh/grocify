    ...
    <header className="bg-white fixed top-0 left-0 right-0">
      <nav className="max-w-[1400px] mx-auto md:h-[14vh] h-[12vh] px-10 items-center flex justify-between">
        ...
        <div className="flex items-center gap-x-5">
            {/* Input field */}
            <div className="md:flex bg-red-100 p-1 border-2 border-orange-500 rounded-full hidden">
        ...
        {/* Mobile menu */}
        <ul className={`flex flex-col gap-y-12 bg-orange-500/15 backdrop-blur-xl p-10 rounded-xl items-center gap-x-15 md:hidden absolute top-30 -left-full tranform -translate-x-1/2 transition-all duration-300 ${showMenu ? 'left-1/2' : ""}`}>
          <li>
            <a
              href="#"
              className="font-semibold tracking-wider text-orange-500"
