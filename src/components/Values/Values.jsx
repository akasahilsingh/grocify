    ...
    <section>
        <div className='max-w-[1400px] mx-auto px-10 py-20'>
            ...
            <div className='flex md:flex-row  mt-15 md:gap-3 gap-15 flex-col'>
                {/* Left Values */}
                <div className='md:min-h-100px gap-15 flex flex-col justify-between'> {leftValue}</div>
              <div className='md:flex w-1/2 hidden'>
                <img src={Basket}/>
              </div>
              {/* Right Values */}
              <div className='md:min-h-100px flex gap-15 flex-col justify-between'>{rightValue}</div>
            </div>
        </div>
    </section>
  )
