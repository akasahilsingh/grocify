  ...
  return (
    <section>
      <div className="max-w-[1400px] px-10 mx-auto py-20">
        <Heading highlight="Cusotmer" heading="Saying" />
        <div className="flex justify-end py-5 gap-x-3">
          <button className="text-2xl rounded-lg w-11 h-11 text-zinc-800 flex justify-center items-center hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer">
            <IoIosArrowBack />
          </button>
          <button className="text-2xl rounded-lg w-11 h-11 text-zinc-800 flex justify-center items-center items- hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer">
            <IoIosArrowForward />
          </button>
        </div>
            ...
            return (
              <SwiperSlide className="bg-zinc-100 rounded-xl p-8">
                <div className="flex gap-5 items-center">
                  <div className="w-16 h-16 rounded-full bg-red-500 outline-2 outline-orange-500 oultine-offset-4"></div>
                  <div>
