    ...
    <section>
      <div className="max-w-[1400px] px-10 mx-auto py-20">
        ...
        <div className="flex justify-end py-5 mt-5 gap-x-3">
          <button className="custom-prev text-2xl rounded-lg w-11 h-11 text-zinc-800 flex justify-center items-center hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer">
            <IoIosArrowBack />
          </button>
          <button className="custom-next text-2xl rounded-lg w-11 h-11 text-zinc-800 flex justify-center items-center hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer">
            <IoIosArrowForward />
          </button>
        </div>
