  ...
  const renderSteps = steps.map((item) => {
    return (
      <div className={`flex-1 basis-[300px] ${item.id % 2 === 0 ? "md:-mt-100" : ""}`}>
        <span className="flex justify-center items-center w-18 mx-auto rounded-full h-18 text-8xl bg-zinc-800 outline-[3px] text-white outline-offset-7 outline-zinc-800 outline-dashed">
          {item.number}
        </span>
        <div>
